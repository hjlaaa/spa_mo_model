"""Preserved scientific visualization preparation, explicitly outside read-only readers."""
...
from data_io.visualization_inputs import read_lines, selected_original_indices, subset_obs_vars_memory_safe
